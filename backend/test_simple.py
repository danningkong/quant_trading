#!/usr/bin/env python3
"""
Simple test script for the Quant Trading project
"""
...
def test_data_fetcher():
    ...
    if not missing_indicators:
        print("  [SUCCESS] All technical indicators calculated")
...
def main():
    ...
    try:
        ...
        if not success:
            print("[FAILED] Data fetcher tests failed!")
            return
    except Exception as e:
        print(f"[FAILED] Data fetcher test error: {e}")
        return
    ...
    print("[SUCCESS] Data fetching works correctly")
